...
import * as http from 'https://deno.land/std@0.80.0/http/server.ts';
export type {
  Response,
...
import { STATUS_TEXT } from "https://deno.land/std@0.80.0/http/http_status.ts";
...
// recreate the signatures of https://deno.land/std@0.80.0/http/server.ts
